...
// Cho phép đăng kí http headers.
app.use(helmet());
app.use(cookieParser());
app.set("view engine", "ejs");
app.set("views", "views");

/* BUSINESS CHO LOGIC SERVER. */

const logic_authorization = (req, res, next) => {
...
app.post("/api/v1/insert-movie", logic_authorization, async (req, res) => {
...
app.post("/api/v1/delete-movie", logic_authorization, async (req, res) => {
...
app.post("/api/v1/get-movie", logic_authorization,async (req, res) => {
...
/* BUSINESS CHO AUTHEN-AUTHOR SERVER */
// generate token.
...
const auth_authorization = (req, res, next) => {
...
app.post("/auth/logout", auth_authorization, (req, res) => {
